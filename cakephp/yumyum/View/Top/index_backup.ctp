...
<head>
    ...
    <script>
        ...
        function initialize() {
            ...
            setInfoWindow(marker,"<?=$data['Restaurant']['name']?>","<?=$data['Restaurant']['image_file_name']?>","<?=$data['Restaurant']['money']?>");
            <?php endforeach;?>
	...
	var  infoWindow;
        function setInfoWindow(marker, message,imgpath,price){
            ...
            $.ajax({
                ...
                success: function(json) {
                    ...
                    for(var index in json.result){
                        ...
                        setInfoWindow(marker,restaurant.name,restaurant.image_file_name,restaurant.money);

                        content += '<div class="shop_list--block__content">' +
                            '<a href="#"><img src="'+restaurant.image_file_name+'" alt="肉割烹 将泰庵[和牛炙り鉄火丼]" />' +
                            '<ul>'+
